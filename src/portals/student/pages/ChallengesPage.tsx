// src/portals/student/pages/ChallengesPage.tsx
import { useEffect, useState } from "react";
// import { useNavigate } from "react-router-dom";
import { studentChallengesApi } from "@/services/api/student/challenges.api";
import type { Challenge } from "@/types/api/student/challenges";
...
export default function ChallengesPage() {
  ...
  const loadChallenges = async (page: number) => {
    try {
      setLoading(true);
      setError(null);
      const response = await studentChallengesApi.getAll(page, 20);
