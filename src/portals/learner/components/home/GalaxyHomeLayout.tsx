// src/portals/learner/components/home/GalaxyHomeLayout.tsx
...
import type { LearnerHomeVM } from "@/portals/learner/components/home/home.types";

export default function GalaxyHomeLayout({ vm }: { vm: LearnerHomeVM }) {
  return (
